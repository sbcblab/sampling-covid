...
sales_data = pd.read_csv("DATA/FLEURY-FM-ORIGINAL.csv")
sales_teste = pd.read_csv("DATA/FLEURY-FM-ORIGINAL.csv") # teste
...
svmParm = open("ORIGINAL-RESULTADOS/svmparm.txt","w")
rfParm = open("ORIGINAL-RESULTADOS/rfparm.txt","w")
sgbcParm = open("ORIGINAL-RESULTADOS/sgbcparm.txt","w")
dtParm  = open("ORIGINAL-RESULTADOS/dtparm.txt","w")
knnParm = open("ORIGINAL-RESULTADOS/knnparm.txt","w")
lrParm  = open("ORIGINAL-RESULTADOS/lrparm.txt","w")
mlpParm  = open("ORIGINAL-RESULTADOS/mlpparm.txt","w")
nbParm  = open("ORIGINAL-RESULTADOS/nbparm.txt","w")
...
for i in tqdm(range(1,runs)):
   ...
   # X_test=(X_test-X_test.mean())/X_test.std()
    ...
    NB(i,X_train, X_test, y_train, y_test)
    print("Running SVM: ",i)
    SVM(i,X_train, X_test, y_train, y_test)
    print("Running RF: ",i)
    RF(i, X_train, X_test, y_train, y_test)
    print("Running XGBC: ",i)
    XGBC(i, X_train, X_test, y_train, y_test)
    print("Running DT: ",i)
    DT(i, X_train, X_test, y_train, y_test)
    print("Running KNN: ",i)
    KNN(i, X_train, X_test, y_train, y_test)
    print("Running LR: ",i)
    LR(i, X_train, X_test, y_train, y_test)
    print("Running MLP: ",i)
    MLP(i, X_train, X_test, y_train, y_test)
...
def saveCSV(dic,nome):
    ...
    # save to csv file
    savetxt("ORIGINAL-RESULTADOS/"+nome+".csv", data, delimiter=',')


saveCSV(svmF,"SVM-ORIGINAL")
saveCSV(rfF,"RF-ORIGINAL")
saveCSV(xgbcF,"XGBC-ORIGINAL")
saveCSV(dtF,"DT-ORIGINAL")
saveCSV(knnF,"KNN-ORIGINAL")
saveCSV(lrF,"LR-ORIGINAL")
saveCSV(mlpF,"MLP-ORIGINAL")
saveCSV(nbF,"NB-ORIGINAL")
