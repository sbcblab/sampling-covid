...
svmParm = open("SMOTE-RESULTADOS/svmparm.txt","w")
rfParm = open("SMOTE-RESULTADOS/rfparm.txt","w")
sgbcParm = open("SMOTE-RESULTADOS/sgbcparm.txt","w")
dtParm  = open("SMOTE-RESULTADOS/dtparm.txt","w")
knnParm = open("SMOTE-RESULTADOS/knnparm.txt","w")
lrParm  = open("SMOTE-RESULTADOS/lrparm.txt","w")
mlpParm  = open("SMOTE-RESULTADOS/mlpparm.txt","w")


nbParm  = open("SMOTE-RESULTADOS/nbparm.txt","w")
...
def saveCSV(dic,nome):
    ...
    # save to csv file
    savetxt("SMOTE-RESULTADOS/"+nome+".csv", data, delimiter=',')


saveCSV(svmF,"SVM-SMOTE")
saveCSV(rfF,"RF-SMOTE")
saveCSV(xgbcF,"XGBC-SMOTE")
saveCSV(dtF,"DT-SMOTE")
saveCSV(knnF,"KNN-SMOTE")
saveCSV(lrF,"LR-SMOTE")
saveCSV(mlpF,"MLP-SMOTE")
saveCSV(nbF,"NB-SMOTE")
