...
svmParm = open("SMOTETomek-RESULTADOS/svmparm.txt","w")
rfParm = open("SMOTETomek-RESULTADOS/rfparm.txt","w")
sgbcParm = open("SMOTETomek-RESULTADOS/sgbcparm.txt","w")
dtParm  = open("SMOTETomek-RESULTADOS/dtparm.txt","w")
knnParm = open("SMOTETomek-RESULTADOS/knnparm.txt","w")
lrParm  = open("SMOTETomek-RESULTADOS/lrparm.txt","w")
mlpParm  = open("SMOTETomek-RESULTADOS/mlpparm.txt","w")


nbParm  = open("SMOTETomek-RESULTADOS/nbparm.txt","w")
...
def saveCSV(dic,nome):
    ...
    # save to csv file
    savetxt("SMOTETomek-RESULTADOS/"+nome+".csv", data, delimiter=',')


saveCSV(svmF,"SVM-SMOTETomek")
saveCSV(rfF,"RF-SMOTETomek")
saveCSV(xgbcF,"XGBC-SMOTETomek")
saveCSV(dtF,"DT-SMOTETomek")
saveCSV(knnF,"KNN-SMOTETomek")
saveCSV(lrF,"LR-SMOTETomek")
saveCSV(mlpF,"MLP-SMOTETomek")
saveCSV(nbF,"NB-SMOTETomek")
