...
svmParm = open("ADASYN-RESULTADOS/svmparm.txt","w")
rfParm = open("ADASYN-RESULTADOS/rfparm.txt","w")
sgbcParm = open("ADASYN-RESULTADOS/sgbcparm.txt","w")
dtParm  = open("ADASYN-RESULTADOS/dtparm.txt","w")
knnParm = open("ADASYN-RESULTADOS/knnparm.txt","w")
lrParm  = open("ADASYN-RESULTADOS/lrparm.txt","w")
mlpParm  = open("ADASYN-RESULTADOS/mlpparm.txt","w")
nbParm  = open("ADASYN-RESULTADOS/nbparm.txt","w")
...
def saveCSV(dic,nome):
    ...
    # save to csv file
    savetxt("ADASYN-RESULTADOS/"+nome+".csv", data, delimiter=',')

saveCSV(svmF,"SVM-ADASYN")
saveCSV(rfF,"RF-ADASYN")
saveCSV(xgbcF,"XGBC-ADASYN")
saveCSV(dtF,"DT-ADASYN")
saveCSV(knnF,"KNN-ADASYN")
saveCSV(lrF,"LR-ADASYN")
saveCSV(mlpF,"MLP-ADASYN")
saveCSV(nbF,"NB-ADASYN")
