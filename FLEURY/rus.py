...
svmParm = open("RUS-RESULTADOS/svmparm.txt","w")
rfParm = open("RUS-RESULTADOS/rfparm.txt","w")
sgbcParm = open("RUS-RESULTADOS/sgbcparm.txt","w")
dtParm  = open("RUS-RESULTADOS/dtparm.txt","w")
knnParm = open("RUS-RESULTADOS/knnparm.txt","w")
lrParm  = open("RUS-RESULTADOS/lrparm.txt","w")
mlpParm  = open("RUS-RESULTADOS/mlpparm.txt","w")


nbParm  = open("RUS-RESULTADOS/nbparm.txt","w")
...
def saveCSV(dic,nome):
    ...
    # save to csv file
    savetxt("RUS-RESULTADOS/"+nome+".csv", data, delimiter=',')


saveCSV(svmF,"SVM-RUS")
saveCSV(rfF,"RF-RUS")
saveCSV(xgbcF,"XGBC-RUS")
saveCSV(dtF,"DT-RUS")
saveCSV(knnF,"KNN-RUS")
saveCSV(lrF,"LR-RUS")
saveCSV(mlpF,"MLP-RUS")
saveCSV(nbF,"NB-RUS")
